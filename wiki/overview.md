...
- Rebinding the three already approved official-note repairs produced private successor SHA-256 `35ed3713ee222c2778d58f3962c016ea2fef888bc0f8be4edb2b6aacf5641a4d`: 9,827 notes, 7,213 reference-bearing notes, 2,614 no-reference notes, zero blockers, and 13,136 edges (7,972 internal and 5,164 external). Strict candidate loading passed. This is a review result, not acceptance; neither candidate was imported or activated.
...
- Phase 1 U1-U3 remain completed source-independent groundwork, but U4-U7 are paused. The next corpus gate is a truthful acquisition record bound to the restored raw inputs, a separate encrypted off-workstation backup with a verified restore path, and maintainer approval of exact successor SHA-256 `35ed3713ee222c2778d58f3962c016ea2fef888bc0f8be4edb2b6aacf5641a4d`. Import and post-import verification follow that approval; activation remains a separate later action. Only then can the real HTTP/MCP study flow and full local product-loop evaluation resume.
...
- Which encrypted off-workstation backup destination and restore procedure will close the corpus-acceptance backup gate?
