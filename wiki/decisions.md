...
- The repaired Book of Mormon successor requires a truthful raw-source acquisition record, a separate encrypted off-workstation backup, and a new exact-digest approval decision; import verification and activation remain separate.
