...
**2026-08-25 local-beta status:** A terminal-boundary audit invalidated the prior Book of Mormon base candidate, SQLite corpus, and typed-edge successor. All three remain quarantined from evidence and evaluation. The repaired exact successor passed private rebuild, provenance, typed-edge, exact-digest approval, import, and verification gates and is now active as corpus `corpus-eb076af14ec6fff84eb40cf0` with baseline `baseline-27ce2c9404b2a0e0df20859b`. The next gate is the locked broad-question evaluation and repeated real local HTTP/MCP study flow.
...
The version-controlled Book of Mormon snapshot contains all 6,604 canonical identities and 9,826 footnote anchors, but a 2026-08-25 audit found that its final canonical record contained 1,027,420 characters, 3,486 source spans, and pages 554-795 because the parser lacked a terminal source boundary. The maintainer withdrew editorial authority from base SHA-256 `1dfd7b927e9fe5f4987a5bb5a3c8d1a0398eec6004cd01f45e86d50096a1e6b4`, corpus `corpus-7ba9051125f848e1aed71c46`, and typed successor SHA-256 `5207e9c1c003f12798053c667a997e8e0697495f8f4a9cafb2e112ef3aee7fa5`; the old corpus is now inactive and all three identities remain quarantined from evidence and evaluation. `official-reference-v2` remains grammar-capability resolved, including typed whole-unit targets. Rebuilt exact successor SHA-256 `35ed3713ee222c2778d58f3962c016ea2fef888bc0f8be4edb2b6aacf5641a4d` is accepted, verified, and active as corpus `corpus-eb076af14ec6fff84eb40cf0` with baseline `baseline-27ce2c9404b2a0e0df20859b`. The separate New Testament candidate snapshot contains 27 books, 260 chapters, 7,957 passages, and 10,091 footnote anchors and remains inactive, unaccepted, and `review_required` without typed edges.
...
- R95b local-beta exception. For exact repaired Book of Mormon successor SHA-256 `35ed3713ee222c2778d58f3962c016ea2fef888bc0f8be4edb2b6aacf5641a4d`, the maintainer explicitly waived R95b only as a pre-acceptance gate for the single-maintainer local-only beta and accepted loss/rebuild risk. No backup or restore-path claim is made. R95b still blocks remote delivery and storage of irreplaceable member data.
...
- Do not use the quarantined Book of Mormon base, old corpus, or typed successor for evidence or evaluation. Repaired successor SHA-256 `35ed3713ee222c2778d58f3962c016ea2fef888bc0f8be4edb2b6aacf5641a4d` passed the digest, acquisition-record, fidelity, maintainer-approval, import, verification, and separate activation gates and is active as corpus `corpus-eb076af14ec6fff84eb40cf0` with baseline `baseline-27ce2c9404b2a0e0df20859b`.
- Keep the quarantined old corpus immutable but inactive. It remains historical control data, not evidence authority.
...
- O1. Resolved as active local-beta behavior: `official-reference-v2` converts the observed Book of Mormon reference notation into typed internal or external targets and supports approved digest-bound repairs and typed whole-unit targets. The prior exact-corpus proof remains quarantined because its base corpus failed terminal fidelity. The private rebuild, official-edge rederivation, verification, new exact-digest approval, acceptance, and separate activation gates are complete for the repaired successor.
...
The maintainer approved this specification on 2026-08-23, revised the Supabase Auth risk decision on 2026-08-24, added the local-beta-first sequencing amendment on 2026-08-24, and on 2026-08-25 withdrew editorial authority from the corrupted Book of Mormon lineage while authorizing repair and private rebuild. Later that day the maintainer approved the truthful reconstructed-source record and exact repaired successor SHA-256 `35ed3713ee222c2778d58f3962c016ea2fef888bc0f8be4edb2b6aacf5641a4d`, waived R95b only as its local-beta pre-acceptance gate, accepted it as corpus `corpus-eb076af14ec6fff84eb40cf0`, and separately activated it with baseline `baseline-27ce2c9404b2a0e0df20859b`. O1 is resolved as active behavior against that exact corpus. O2 still blocks acceptance of the New Testament and later standard works. The locked local-beta evaluation and repeated real-use gate blocks resuming U4-U7 and the hosted critical path. O5 blocks the first enrichment run. O11, O12, and the bounded R63a regression block remote alpha. O10 blocks any public ChatGPT submission. Other open technical questions belong to later architecture and implementation planning.
