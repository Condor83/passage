...
formerly selected local corpus `corpus-7ba9051125f848e1aed71c46`, and private
typed successor SHA-256
`5207e9c1c003f12798053c667a997e8e0697495f8f4a9cafb2e112ef3aee7fa5`.
All three are quarantined from evidence and evaluation. The old corpus remains
immutable historical control data but is inactive and without editorial
authority. The successor must not be imported or accepted.
...
on 2026-08-25 and is now active with baseline
`baseline-27ce2c9404b2a0e0df20859b`. The New Testament candidate remains
...
these commit-time manifests. The next Book of Mormon gate is the locked local
product-loop evaluation and repeated real HTTP/MCP study flow. The maintainer waived off-workstation backup
